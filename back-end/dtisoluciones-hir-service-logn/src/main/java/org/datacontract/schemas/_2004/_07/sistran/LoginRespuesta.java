...
/**
 * <p>Clase Java para LoginRespuesta complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="LoginRespuesta">
 *   &lt;complexContent>
...
@XmlType(name = "LoginRespuesta", namespace = "http://schemas.datacontract.org/2004/07/Sistran.Login", propOrder = {
    "confirmacionToken"
})
