...
@XmlRootElement(name = "ConsultaCatalogoPostal")
public class ConsultaCatalogoPostal {

    @XmlElementRef(name = "CP", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
