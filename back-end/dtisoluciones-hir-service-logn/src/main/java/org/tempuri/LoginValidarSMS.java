...
@XmlRootElement(name = "loginValidarSMS")
public class LoginValidarSMS {

    @XmlElementRef(name = "idCodigo", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> idCodigo;
     ...
     *     
     */
    public JAXBElement<String> getIdCodigo() {
        return idCodigo;
    }
     ...
     *     
     */
    public void setIdCodigo(JAXBElement<String> value) {
        this.idCodigo = value;
    }
