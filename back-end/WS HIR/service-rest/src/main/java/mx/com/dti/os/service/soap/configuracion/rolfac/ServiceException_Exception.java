 ...
 * 
 */
@WebFault(name = "ServiceException", targetNamespace = "http://rolfac.configuracion.soap.eservices.os.planetmedia.com.mx")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: mx.com.planetmedia.os.eservices.soap.configuracion.rolfac.ServiceException
     */
