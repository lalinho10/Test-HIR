 ...
 * 
 */
@WebFault(name = "ServiceException", targetNamespace = "http://states.configuracion.soap.eservices.os.planetmedia.com.mx")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: mx.com.planetmedia.os.eservices.soap.configuracion.states.ServiceException
     */
